...
std::vector<double> TechnicalIndicators::relative_strength_index(const std::vector<double>& data, int window_size) {
...
std::vector<double> TechnicalIndicators::macd(const std::vector<double>& data, int short_window, int long_window, int signal_window) {
