...
std::vector<double> MomentumTrading::calculate_rsi(const std::vector<double>& prices, int period) {
...
std::vector<int> MomentumTrading::generate_signals(const std::vector<double>& rsi, double rsi_buy_threshold, double rsi_sell_threshold) {
...
double MomentumTrading::backtest_strategy(const std::vector<int>& signals, const std::vector<double>& prices, double trailing_stop_loss_percentage, double fixed_stop_loss_percentage, double cash) {
