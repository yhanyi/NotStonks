...
std::pair<double, double> PairsTrading::calculate_spread(const std::vector<double>& prices1, const std::vector<double>& prices2) {
...
std::pair<std::vector<double>, std::vector<double>> PairsTrading::generate_signals(const std::vector<double>& spread, double entry_threshold, double exit_threshold) {
