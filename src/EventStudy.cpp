...
std::vector<double> EventStudy::calculate_abnormal_returns(const std::vector<double>& returns, const std::vector<double>& market_returns) {
...
double EventStudy::cumulative_abnormal_return(const std::vector<double>& abnormal_returns) {
